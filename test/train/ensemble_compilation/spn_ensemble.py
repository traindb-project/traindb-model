...
import numpy as np
import scipy.stats
from train.ensemble_compilation.graph_representation import Query, QueryType, AggregationType, AggregationOperationType
from train.ensemble_compilation.probabilistic_query import IndicatorExpectation, Expectation
    ...
    for ensemble_location in ensemble_locations:
        with open(ensemble_location, 'rb') as handle:
            ...
            for spn in current_ensemble.spns:
                ...
                #FIXME(2022.09.01): logging.debug(f"Stats: ({get_structure_stats(spn.mspn)})")
                # build reverse dict.
