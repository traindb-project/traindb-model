...
class TVAE(TrainDBSynopsisModel):
    ...
    def train(self, real_data, table_metadata):
        ...
        self.model = sdv.single_table.TVAESynthesizer(metadata=sdv_metadata, **self.model_kwargs)
    ...
    def load(self, input_path):
        self.model = sdv.single_table.TVAESynthesizer.load(os.path.join(input_path, 'model.pkl'))
